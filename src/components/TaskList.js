	...
	<>	
		...
		<tr className="">
		    ...
		    <td  style={{ width: "fit-content", height: "50px"}}>
	        	<div className="d-flex align-items-top justify-content-center pt2" style={{ padding: "5px", width: "fit-content", height: "100%", overflowY: "auto", textOverflow: "hidden", overflowX: "hidden", fontSize: '0.8rem' }}>
