...
function JustifiedExample() {
  ...
  return (
    <Tabs defaultActiveKey="progress" id="justify-tab-example" style={{paddingLeft: "", width: "84vw", left: "15.1vw", right: "0", position: "absolute"}} className="tab-container" justify>
      <Tab style={{marginTop: "4.5vh", left: "15.1vw", position: "absolute", backgroundColor: "burlywood"}} eventKey="progress" title="Projects">
        ...
        <div className="d-flex flex-row justify-content-around pt-5 pb-5 tab-full" style={{background: "#c6fecd", height: "100%", minHeight: "100vh", width: "84vw"}}>
          <DisplayProjectCard />
        </div>
      </Tab>
      ...
      <Tab style={{ marginTop: "4.5vh", left: "15.1vw", position: "absolute", backgroundSize: "cover", backgroundRepeat: "no-repeat", // Prevents the background image from repeating
            height: "fit-content", background: "#97c5dc", height: "fit-content", width: "100%" }} eventKey="home" title="Tasks">
